  ...
  <Center w='40px' h='40px' >
        ...
        <Grid templateColumns="repeat(5, 1fr)" gap={4}>
          <GridItem colSpan={6}>
            ...
            <Select placeholder="Select option" mt={5} mb={5} onChange={e=>setSelects(e.target.value)}>
              <option value="option1">BRIGHTON</option>
              <option value="option2">DARTFORD</option>
              <option value="option3">GALASHIELS</option>
            </Select>
        ...
        <Grid templateColumns="repeat(5, 1fr)" gap={4}>
          <GridItem colSpan={6}>
            ...
            <option value="option1">1-2</option>
              <option value="option1">4-5</option>
              <option value="option1">8-10</option>
            </Select>
          </GridItem>
        ...
        <Grid templateColumns="repeat(5, 1fr)" gap={4}>
          <GridItem colSpan={6}>
            ...
            <Select placeholder="Select option" mt={5} mb={5}>
            <option value="option1">Full Menu</option>
              <option value="option2">Fix Menu</option>
              <option value="option3">Option Menu</option>
            </Select>
          </GridItem>
